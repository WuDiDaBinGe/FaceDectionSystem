...
from threads import SplitVideoThreads,ExtractPicFaceThread
from view.test import Runthread
...
class MainWin(QMainWindow):
    ...
    def spilt_video(self):
        ...
        if video_src_path!='' and frame_save_path!='':
    ...
    def extract_pictures_face(self):
        ...
        if pics_src_path is not None and faces_pics_save_path is not None:
            ...
            self.extract_pictures_thread.split_finish.connect(self.split_video_info)
